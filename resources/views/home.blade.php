...
@section('nav')
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 bg-light opacity-85"
        ...
        <div class="container"><a class="navbar-brand" href="/"><img class="d-inline-block align-top img-fluid"
                                                                     src="img/planting.svg" alt="" width="50"/><span
                    class="text-theme font-monospace fs-4 ps-2"></span></a>
            ...
            <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                ...
                <button class="btn btn-lg btn-dark bg-gradient order-0"
                        onclick="location.href='{{route('photo.index')}}'">AI 시스템
                </button>
...
@section('content')
    ...
    <section class="py-0" id="header">
        <div class="bg-holder d-none d-md-block"
             style="background-image:url({{asset('img/hero-bg.png')}});background-position:right top;background-size:contain;">
        </div>
        ...
        <div class="container">
            <div class="row align-items-center min-vh-75 min-vh-lg-100">
                <div class="col-md-7 col-lg-6 col-xxl-5 py-6 text-sm-start text-center">
                    <h1 class="mt-6 mb-sm-4 fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">AI 인공지능 <br
                            class="d-block d-lg-block"/>작물 병해 진단 시스템</h1>
                    <p class="mb-4 fs-1">PC와 모바일 환경 모두 간편하게 이용하는 <br class="d-block d-lg-block"/> 딥러닝을 이용한 병해 진단 AI 사이트
                    </p><a class="btn btn-lg btn-success" href="#howtouse" role="button" 0>How To Use</a>
                </div>
            </div>
        </div>
    </section>
    <section class="py-5" id="predict">
        <div class="bg-holder d-none d-sm-block"
             style="background-image:url({{asset('img/bg.png')}});background-position:top left;background-size:225px 755px;margin-top:-17.5rem;">
        </div>
        <!--/.bg-holder-->
                ...
                <div class="col-xl-9">
                    <div class="row">
                        <div class="col-md-4 mb-5">
                            <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                                <div class="text-center text-md-start card-hover"><img class="ps-3 icons"
                                                                                       src="{{asset('img/clipboard-data.svg')}}"
                                                                                       height="60" alt=""/>
                                    <div class="card-body">
                                        <h6 class="fw-bold fs-1 heading-color">쉽고 간편한 자가 진단</h6>
                                        <p class="mt-3 mb-md-0 mb-lg-2">사진 한장으로 간편하게 작물의 병해를 자가 진단해 볼 수 있어 빠른 방제가
                                            가능합니다</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mb-5">
                            <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                                <div class="text-center text-md-start card-hover"><img class="ps-3 icons"
                                                                                       src="{{asset('img/phone-vibrate.svg')}}"
                                                                                       height="60" alt=""/>
                                    <div class="card-body">
                        ...
                        <div class="col-md-4 mb-5">
                            <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                                <div class="text-center text-md-start card-hover"><img class="ps-3 icons"
                                                                                       src="{{asset('img/journal-richtext.svg')}}"
                                                                                       height="60" alt=""/>
                                    <div class="card-body">
                ...
                <div class="col-xl-9 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-5">
                            <div class="card text-white"><img class="card-img" src="{{asset('img/leaf.jpg')}}"
                                                              alt="..."/>
                                <div
                                    ...
                                    <div class="pt-lg-3">
                                        ...
                                        <button class="btn btn-lg btn-light text-success" type="button"
                                                onclick="location.href='{{route('photo.index')}}'">Learn More
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-5">
                            <div class="card text-white"><img class="card-img" src="{{asset('img/fruit.jpg')}}"
                                                              alt="..."/>
                                <div
                                    ...
                                    <div class="pt-lg-3">
                                        ...
                                        <button class="btn btn-lg btn-light text-success" type="button"
                                                onclick="location.href='{{route('search.index')}}'">Learn More
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="py-0" id="howtouse">
        <div class="bg-holder"
             style="background-image:url({{asset('img/how-it-works.png')}});background-position:center bottom;background-size:cover;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container-lg">
            <div class="row justify-content-center">
                <div class="col-sm-8 col-md-9 col-xl-5 text-center pt-8">
                    ...
                    <button class="btn btn-lg btn-light text-success" type="button"
                            onclick="location.href='{{route('photo.index')}}'">AI 진단하러 가기
                    </button>
                </div>
                    ...
                    <div class="theme-tab">
                        <ul class="nav justify-content-between">
                            <li class="nav-item" role="presentation"><a class="nav-link active fw-semi-bold"
                                                                        href="#bootstrap-tab1" data-bs-toggle="tab"
                                                                        data-bs-target="#tab1" id="tab-1"><span
                            ...
                            <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold"
                                                                        href="#bootstrap-tab2" data-bs-toggle="tab"
                                                                        data-bs-target="#tab2" id="tab-2"><span
                                        class="nav-item-circle-parent"><span
                                            class="nav-item-circle">02</span></span></a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold"
                                                                        href="#bootstrap-tab3" data-bs-toggle="tab"
                                                                        data-bs-target="#tab3" id="tab-3"><span
                                        class="nav-item-circle-parent"><span
                                            class="nav-item-circle">03</span></span></a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold"
                                                                        href="#bootstrap-tab4" data-bs-toggle="tab"
                                                                        data-bs-target="#tab4" id="tab-4"><span
                                        class="nav-item-circle-parent"><span
